...
namespace TKS_Thuc_Tap_Controller.Danh_Muc
{
	public class CDM_Loai_San_Pham_Controller
	{
		...
		public IList<CDM_Loai_San_Pham> List_DM_Loai_San_Pham()
		{
			IList<CDM_Loai_San_Pham> v_arrRes = new List<CDM_Loai_San_Pham>();
		...
		public CDM_Loai_San_Pham Get_DM_Loai_San_Pham_By_ID(int p_iID)
		{
			...
			try
			{
				CSqlHelper.FillDataTable(CConfig.g_strTKS_Thuc_Tap_Data_Conn_String, v_dt, "sp_sel_Get_DM_Loai_San_Pham_By_ID", p_iID);
