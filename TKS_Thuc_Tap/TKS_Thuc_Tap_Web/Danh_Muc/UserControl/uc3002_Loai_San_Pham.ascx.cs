...
{
	public partial class uc3002_Loai_San_Pham : System.Web.UI.UserControl
	{
		...
		{
			CDM_Loai_San_Pham_Controller v_objCtrDD = new CDM_Loai_San_Pham_Controller();
			try
			{
				List<object> Rows = grdData.GetSelectedFieldValues("Auto_ID", "Ten_Loai_San_Pham");
				...
				foreach (object id in Rows)
				{
					...
					v_objCtrDD.Delete_DM_Loai_San_Pham(v_iAuto_ID, CSession.Active_User_Name);
