<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc3001_Don_Vi_Tinh.ascx.cs" Inherits="TKS_Thuc_Tap_Web.Danh_Muc.UserControl.uc3001_Don_Vi_Tinh" %>
	...
	<div class="col-md-12">
		<dx:ASPxGridView ID="grdData" runat="server" 
			...
			<Columns>
				...
				<dx:GridViewDataTextColumn Caption="Tên đơn vị tính" FieldName="Ten_Don_Vi_Tinh" VisibleIndex="2" Width="200px" >
		...
		<asp:SqlDataSource ID="sqlData" runat="server" 
			...
			InsertCommand="F3001_sp_ins_Don_Vi_Tinh" InsertCommandType="StoredProcedure" 
			SelectCommand="sp_sel_List_DM_Don_Vi_Tinh" SelectCommandType="StoredProcedure" 
			UpdateCommand="F3001_sp_upd_Don_Vi_Tinh" UpdateCommandType="StoredProcedure">
