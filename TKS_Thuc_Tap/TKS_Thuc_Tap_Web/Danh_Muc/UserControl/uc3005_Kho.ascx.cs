...
{
	public partial class uc3005_Kho : System.Web.UI.UserControl
	{
		...
		{
			CDM_Kho_Controller v_objCtrDD = new CDM_Kho_Controller();
			try
			{
				List<object> Rows = grdData.GetSelectedFieldValues("Auto_ID", "Ten_Kho");
				...
				foreach (object id in Rows)
				{
					...
					v_objCtrDD.Delete_DM_Kho(v_iAuto_ID, CSession.Active_User_Name);
