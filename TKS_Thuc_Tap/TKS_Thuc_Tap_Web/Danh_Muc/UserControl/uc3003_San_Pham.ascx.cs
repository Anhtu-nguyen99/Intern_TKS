...
{
	public partial class uc3003_San_Pham : System.Web.UI.UserControl
	{
		...
		{
			CDM_San_Pham_Controller v_objCtrDD = new CDM_San_Pham_Controller();
			try
			{
				List<object> Rows = grdData.GetSelectedFieldValues("Auto_ID", "Ma_San_Pham");
				...
				foreach (object id in Rows)
				{
					...
					v_objCtrDD.Delete_DM_San_Pham(v_iAuto_ID, CSession.Active_User_Name);
