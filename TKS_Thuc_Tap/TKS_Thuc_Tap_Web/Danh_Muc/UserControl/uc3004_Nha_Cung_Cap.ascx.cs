...
{
	public partial class uc3004_Nha_Cung_Cap : System.Web.UI.UserControl
	{
		...
		{
			CDM_Nha_Cung_Cap_Controller v_objCtrDD = new CDM_Nha_Cung_Cap_Controller();
			try
			{
				List<object> Rows = grdData.GetSelectedFieldValues("Auto_ID", "Ten_Nha_Cung_Cap");
				...
				foreach (object id in Rows)
				{
					...
					v_objCtrDD.Delete_DM_Nha_Cung_Cap(v_iAuto_ID, CSession.Active_User_Name);
