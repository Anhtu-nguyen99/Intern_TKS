<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc3005_Kho.ascx.cs" Inherits="TKS_Thuc_Tap_Web.Danh_Muc.UserControl.uc3005_Kho" %>
	...
	<div class="col-md-12">
		<dx:ASPxGridView ID="grdData" runat="server" 
			...
			<Columns>
				...
				<dx:GridViewDataTextColumn Caption="Tên Kho" FieldName="Ten_Kho" VisibleIndex="2" Width="200px" >
		...
		<asp:SqlDataSource ID="sqlData" runat="server" 
			...
			DeleteCommand="sp_del_DM_Kho" DeleteCommandType="StoredProcedure" 
			InsertCommand="F3005_sp_ins_Kho" InsertCommandType="StoredProcedure" 
			SelectCommand="sp_sel_List_DM_Kho" SelectCommandType="StoredProcedure" 
			UpdateCommand="F3005_sp_upd_Kho" UpdateCommandType="StoredProcedure">
			...
			<UpdateParameters>
                ...
                <asp:Parameter Name="Ten_Kho" Type="String" />
