...
{
	public partial class uc3001_Don_Vi_Tinh : System.Web.UI.UserControl
	{
		...
		{
			CDM_Don_Vi_Tinh_Controller v_objCtrDD = new CDM_Don_Vi_Tinh_Controller();
			try
			{
				...
				foreach (object id in Rows)
				{
					...
					v_objCtrDD.Delete_DM_Don_Vi_Tinh(v_iAuto_ID, CSession.Active_User_Name);
